...
print(f"PASS: 14 offered courses, 17 course-term combinations, {len(crns)} CRNs, {len(meetings)} meeting times; multi-meeting Sections preserved; MS6712 unavailable")
